...
class UIFontDictionary(IUIFontDictionaryInterface):
    ...
    def __init__(self, resource_loader: IResourceLoader, locale: str):
        ...
        self.known_font_paths: Dict[str, List[Tuple[Union[str, bytes], bool]]] = {}
    ...
    def _load_default_font(self):
        ...
        default_font_res = FontResource(
            ...
            location=(
                os.path.normpath('pygame_gui_data/' + self.default_font.regular_file_name),
                False,
            )
        )
        ...
        self.known_font_paths[self.default_font.name] = [
            (os.path.normpath('pygame_gui_data/' + self.default_font.regular_file_name), False),
            (os.path.normpath('pygame_gui_data/' + self.default_font.bold_file_name), False),
            (os.path.normpath('pygame_gui_data/' + self.default_font.italic_file_name), False),
            (os.path.normpath('pygame_gui_data/' + self.default_font.bold_italic_file_name), False),
        ]
